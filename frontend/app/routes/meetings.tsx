...
import { byYear } from "~/lib/meetings";
...
export default function Meetings(props: Route.ComponentProps) {
  if (props.loaderData.meetings.length === 0) {
    return (
  ...
  return (
    <div className="space-y-8">
      ...
      {byYear(props.loaderData.meetings).map(([year, group]) => (
        <section key={year}>
